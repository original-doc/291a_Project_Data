#!/usr/bin/env python3
"""
Manual Baseline Creation Tool
Helps create ground truth retrieval results for evaluation
"""
...
class ManualBaselineCreator:
    ...
    def display_document(self, doc: Dict, index: int = None):
        ...
        print(f"Class: {doc.get('class_name', 'N/A')}")
...
def load_test_queries(queries_file: Path = None) -> List[Dict]:
    ...
    return [
        ...
        {"id": 9, "type": "implementation", "query": "Implement custom callback in PyTorch Lightning"},
        {"id": 10, "type": "implementation", "query": "Multi-GPU training setup"},
        {"id": 11, "type": "implementation", "query": "Custom validation step implementation"},
        {"id": 12, "type": "implementation", "query": "Gradient accumulation example"},
        {"id": 13, "type": "conceptual", "query": "Difference between training_step and validation_step"},
        {"id": 14, "type": "conceptual", "query": "How does automatic optimization work?"},
        {"id": 15, "type": "conceptual", "query": "What is a LightningModule?"},
    ]

def main():
    parser = argparse.ArgumentParser(description="Create manual baseline for retrieval evaluation")
    ...
    parser.add_argument('--output', default='manual_baseline.json', help="Output file")
    ...
    print("="*70)
    print("Manual Baseline Creation Tool")
    print("="*70)
